...
// Provides the core game loop, undo/redo, save/load, and in-game command signalling
// so individual game classes only need to implement their own rules and board logic.
